...
Item_adj$Interpretability_adj =  -Item_adj$Interpretability* 20

## add a simple interaction here!
Item_adj$Interpretability_adj[41:60] = -Item_adj$Interpretability[41:60]* 60
...
save(dat, file="data/example2_dat.RData")
